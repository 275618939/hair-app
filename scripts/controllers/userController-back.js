define(['controllers/controllers', 'services/userService', 'services/commonService', 'services/consultService', 'services/paramService', 'services/courseService', 'services/consultDaoService'],
    function (controllers) {
        ...
        /*用户注册*/
        controllers.controller('RegisterCtrl', ['$log', '$scope', 'UserService', 'CommonService', '$rootScope',
            function ($log, $scope, userService, commonService, $rootScope) {
                ...
                $scope.sendCaptcha = function () {
                    ...
                    $log.debug('$register phone:' + phone);
                    var promise = userService.sendVerify(phone);
                    promise.then(function (data) {
                        if (data.state != 1) {
                            alert(data.desc)
                            $log.debug('$register response desc:' + desc);
                            return;
                        }
